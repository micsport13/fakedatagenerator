...
class DataTypeFactoryTest {
    ...
    public void create_withVarcharDataType_ReturnsVarcharDataType() {
        VarcharDataType varcharDataType = (VarcharDataType) DataTypeFactory.create("varchar", inputParameters);
        assertEquals("VarcharDataType", VarcharDataType.class.getSimpleName(), varcharDataType.getClass().getSimpleName());
        assertEquals(1, varcharDataType.getMaxLength());
    }

    @Test
    public void create_withDecimalDataType_ReturnsConstructedDecimalDataType() {
        DecimalDataType decimalDataType = (DecimalDataType) DataTypeFactory.create("decimal", inputParameters);
        assertEquals("DecimalDataType", DecimalDataType.class.getSimpleName(), decimalDataType.getClass().getSimpleName());
    ...
    public void create_withIntegerDataType_ReturnsConstructedIntegerDataType() {
        IntegerDataType integerDataType = (IntegerDataType) DataTypeFactory.create("integer", inputParameters);
        assertEquals("IntegerDataType", IntegerDataType.class.getSimpleName(), integerDataType.getClass().getSimpleName());
    }
