...
public class ColumnConstraintFactoryTest {
  ...
  public void createConstraint_withValidAcceptedValues_ReturnsValidCheckConstraint() {
    assertTrue(
        ColumnConstraintFactory.createConstraint("Test", "Test2") instanceof ColumnCheckConstraint);
  }

  @Test
  public void createConstraint_withRangeValues_ReturnsValidCheckConstraint() {
    assertTrue(
        ColumnConstraintFactory.createConstraint(new IntegerDataType(), 0, 10)
            instanceof ColumnCheckConstraint);
  }

  @Test
  public void createConstraint_withMaxValueOnly_ReturnsValidCheckConstraint() {
    Constraint maxCheckConstraint =
        ColumnConstraintFactory.createConstraint(new IntegerDataType(), null, 10);
