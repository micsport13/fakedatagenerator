...
public class TableValidatorFactory implements ValidatorFactory {
    ...
    public Validator createValidator(ConstraintType constraintType){
        return switch (constraintType) {
            ...
            case FOREIGN_KEY -> throw new UnsupportedOperationException();// ForeignKeyValidator(); // TODO: Figure out how to implement these
            case UNIQUE -> new UniqueValidator();
            case CHECK -> throw new UnsupportedOperationException();//new CheckValidator();  // TODO: Figure out how to implement these
