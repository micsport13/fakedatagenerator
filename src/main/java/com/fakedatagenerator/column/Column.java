...
import com.fakedatagenerator.validators.OtherValidators.NameValidator;
...
public class Column <T> {
     ...
     */
    public Column(@JsonProperty("columnName") String columnName, @JsonProperty("dataType") Class<T> dataType) {
