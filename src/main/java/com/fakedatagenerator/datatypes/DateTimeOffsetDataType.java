...
public class DateTimeOffsetDataType implements DataType<ZonedDateTime> {
  ...
  public DateTimeOffsetDataType(ZoneOffset zoneOffset) {
      ...
      for (var format : formats) {
        try {
          DateTimeFormatter dtf =
              new DateTimeFormatterBuilder().append(format).appendPattern("XX").toFormatter();
          return ZonedDateTime.parse(value.toString(), dtf);
