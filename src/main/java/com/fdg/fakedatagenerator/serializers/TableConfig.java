...
public class TableConfig {
  public static final ObjectMapper objectMapper = YAMLMapper.builder().enable(YAMLGenerator.Feature.INDENT_ARRAYS_WITH_INDICATOR).disable(SerializationFeature.FAIL_ON_EMPTY_BEANS).build();
