...
public class UniqueLevelConstraint implements TableLevelConstraint {
  ...
  public void validate(Object value) {
    if (this.uniqueValues.contains(value)) {
      throw new UniqueConstraintException(
          UniqueLevelConstraint.class.getSimpleName()
  ...
  public boolean equals(Object obj) {
    ...
    return obj instanceof UniqueLevelConstraint;
  }
